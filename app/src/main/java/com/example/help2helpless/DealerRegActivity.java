...
public class DealerRegActivity extends AppCompatActivity {
    ...
    public   ArrayList <Sections> currencies;
     ...
     */
        ...
        signup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(TextUtils.isEmpty(thana) ||TextUtils.isEmpty(zilla) ||profile_bitmap==null || regno_bitmap==null ||TextUtils.isEmpty(daddres) ||  TextUtils.isEmpty(dlmail) || TextUtils.isEmpty(dlZilla) || TextUtils.isEmpty(name) || TextUtils.isEmpty(password) || TextUtils.isEmpty(phone)){
                    dialogue.cancel();
                    ...
                    Call<Responses> responsesCall=apiInterface.dealerSignResponse(name,phone,password,imageToString(profile_bitmap),daddres,zilla,thana,dlmail,imageToString(regno_bitmap));
  ...
  ;
    ...
    private void initAll() {
        ...
        dladdress=findViewById(R.id.d_address);
