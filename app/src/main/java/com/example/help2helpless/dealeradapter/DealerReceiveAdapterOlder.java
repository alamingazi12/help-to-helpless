...
public class DealerReceiveAdapterOlder extends RecyclerView.Adapter<DealerReceiveAdapterOlder.RecordViewHolder> {

    public DealerReceiveAdapterOlder(ArrayList<DealerReceiveRecord> recordslist, Context context) {
        this.recordslist = recordslist;
        this.context = context;
    }
    public DealerReceiveAdapterOlder(ArrayList<DealerReceiveRecord> recordslist, Context context,int value) {
        this.recordslist = recordslist;
        this.context = context;
        this.value=value;
    }

    static   ArrayList<DealerReceiveRecord> recordslist;
    Context context;
    int value;
    @NonNull
    @Override
    public DealerReceiveAdapterOlder.RecordViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.send_record_item,parent,false);
        return new DealerReceiveAdapterOlder.RecordViewHolder(view);
    }
    ...
    public void onBindViewHolder(@NonNull RecordViewHolder holder, int position) {
        ...
        DealerReceiveRecord record=  recordslist.get(position);

        holder.dealer_name.setText(record.getDname());
        ...
        String imageUrl="https://apps.help2helpless.com/donar_profile/"+record.getDonar_photo();
