...
public class DealerReceiveAdapterToday extends RecyclerView.Adapter<DealerReceiveAdapterToday.RecordViewHolder> {

    public DealerReceiveAdapterToday(ArrayList<DealerReceiveRecord> recordslist, Context context) {
        this.recordslist = recordslist;
        this.context = context;
    }
    public DealerReceiveAdapterToday(ArrayList<DealerReceiveRecord> recordslist, Context context,int value) {
        this.recordslist = recordslist;
        this.context = context;
        this.value=value;
    }
  ...
  static   ArrayList<DealerReceiveRecord> recordslist;
    ...
    @NonNull
    @Override
    public DealerReceiveAdapterToday.RecordViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.send_record_item,parent,false);
        return new DealerReceiveAdapterToday.RecordViewHolder(view);
    }
