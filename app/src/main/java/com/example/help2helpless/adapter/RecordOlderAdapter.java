...
public class RecordOlderAdapter extends RecyclerView.Adapter<RecordOlderAdapter.RecordViewHolder> {

public RecordOlderAdapter(ArrayList<DonarSendRecord> recordslist, Context context) {
